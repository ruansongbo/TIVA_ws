...
#define SCLK(x)     x ? GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_4,GPIO_PIN_4) : GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_4,0x00)
#define MOSI(x)     x ? GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_5,GPIO_PIN_5) : GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_5,0x00)
#define RST(x)      x ? GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_6,GPIO_PIN_6) : GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_6,0x00)
#define DC(x)       x ? GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_7,GPIO_PIN_7) : GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_7,0x00)
...
const UCHAR8 F14x16[] =
{
   ...
   // 0x00,0x00,0x01,0x01,0x01,0x41,0x41,0x3F,0x01,0x01,0x01,0x00,0x00,0x00,/*"子",3*/
    ...
    0x20,0x10,0x08,0xFC,0x57,0x54,0x54,0xFD,0x56,0x54,0x54,0x56,0x04,0x00,
    0x04,0x44,0x44,0x27,0x15,0x0D,0x05,0xFF,0x05,0x0D,0x15,0x25,0x65,0x24,/*"集",10*/
    0x04,0x04,0x14,0x24,0x04,0x04,0xD4,0x24,0x02,0x22,0x12,0x1B,0x82,0x00,
    0x21,0x21,0x11,0x09,0x05,0x03,0xFF,0x03,0x05,0x09,0x09,0x11,0x31,0x11,/*"采",11*/
    0x10,0x10,0xFF,0x90,0x50,0xFE,0x92,0x92,0x92,0xF2,0x92,0x92,0xDF,0x82,
    0x42,0x81,0x7F,0x40,0x38,0x07,0xFC,0x44,0x44,0x47,0x44,0x44,0xFE,0x04,/*"据",12*/
    0x92,0x54,0x30,0xFF,0x50,0x94,0x32,0xD8,0x17,0x10,0x10,0xF0,0x18,0x10,
    0x82,0x4E,0x33,0x22,0x52,0x8E,0x40,0x23,0x14,0x08,0x16,0x61,0xC0,0x40,/*"数",13*/
...
void my_image_print(uint8_t *image)
{
    uint8_t i,j;
    for(j=2;j<8;j++)
    {
